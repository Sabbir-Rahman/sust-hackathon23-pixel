      ...
      <div className="flex gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-lightGray">
            ...
            Atque officia aperiam nisi cupiditate, hic quae assumenda, esse est
            sed accusamus illum aut architecto qui saepe provident perferendis
            molestiae quibusdam tenetur inventore voluptate praesentium
            sapiente. Sed hic reiciendis consequuntur delectus obcaecati cum
            aperiam magni? Hic eos iusto numquam non. Quae dolorem, architecto
            eveniet atque quibusdam enim deserunt similique animi eaque sit
            deleniti quaerat
          </p>
        </div>
      </div>
